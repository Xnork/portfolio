const load_projects_card = () => {
  let projects = [
    ...
    title: 'NoobBank Mobile', text: 'Um site que simula a interface de um app bancário, que "utiliza" blockchain, inspirado no layout da nubank. É ideias fantasiosas, mas o código ficou relativamente bem estruturado.', tools: 'HTML, CSS'},
    ...
    {url: 'https://github.com/Xnork/SDL2-Platform-Game-Learning', background: 'https://github.com/Xnork/SDL2-Platform-Game-Learning/blob/main/assets/screenshots/1.png?raw=true',
    ...
    {url: 'https://github.com/Xnork/RocketSimulator', background: 'https://github.com/Xnork/RocketSimulator/blob/main/data/screenshots/2.png?raw=true',
    ...
    {url: 'https://github.com/Xnork/SDL2-2D-Game-Plataform', background: 'https://github.com/Xnork/SDL2-2D-Game-Plataform/blob/main/prints/image_2.png?raw=true',
    ...
    {url: 'https://github.com/Xnork/SDL2-Load-TMX-From-Tiled', background: 'https://github.com/Xnork/SDL2-Load-TMX-From-Tiled/blob/main/data/screenshots/2.png?raw=true',
    ...
    {url: 'https://github.com/Xnork/ProgressBar', background: 'https://github.com/Xnork/ProgressBar/blob/main/screenshots/1-fix.png?raw=true',
    ...
    {url: 'https://github.com/Xnork/TODO-List-Cpp', background: 'https://github.com/Xnork/TODO-List-Cpp/blob/main/data/screenshots/3.png?raw=true',
